      ...
      <section className="landing_quote_and_image flex p-20 bg-[#007F73] rounded-md ">
        <div className="landing_quote w-1/2 flex flex-col justify-center items-center ">
          ...
          <h1 className="text-white drop-shadow-2xl shadow-black text-center text-xl font-light tracking-wider m-5">
            Embark on a visual journey at Creatives School of Arts. Our curated
          ...
          <Link
            to="/gallery"
            className=" mt-28 border-2 border-[#FFC700] w-1/2 flex justify-center items-center p-5 rounded-lg text-xl font-medium bg-[#FFC700] hover:animate-pulse duration-150 ease-in-out hover:scale-105 hover:border-none shadow-sm shadow-black"
          >
            <h1>Gallery</h1>
          </Link>
        </div>
