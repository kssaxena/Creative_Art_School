...
const ImageSliderArtExhibition = () => {
  ...
  return (
    <section className={` flex justify-around items-center m-10 rounded-2xl shadow-md shadow-black hover:shadow-lg hover:shadow-black duration-300 ease-in-out hover:scale-110`}>
...
export default ImageSliderArtExhibition;
